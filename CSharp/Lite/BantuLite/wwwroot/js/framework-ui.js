...
$.loading = function (bool, text) {
    ...
    if (!!text) {
        ...
        $loadingtext.html("Data loading, please wait…");
    }
...
$.modalClose = function () {
    var index = top.layer.getFrameIndex(window.name); //First get the index of the current iframe layer
...
$.deleteForm = function (options) {
    var defaults = {
        prompt: "Note: Are you sure you want to delete the data？",
        url: "",
        param: [],
...
$.fn.upperCaseF = function (options) {
    setTimeout(function () {
...
/**
 * 
 * @param var promise = $.callPostAjax(options);
 * promise.success(function (data) {alert(data);});
 * 
 */

$.callPostAjax = function (options) {
